...
urlpatterns = [
    ...
    path(
        "api/realestate-booking/", views.realestate_booking, name="realestate_booking"
    ),
    path(
        "api/delete-property/<int:id>/", views.delete_property, name="delete_property"
    ),
...
urlpatterns += [
    re_path(r"^media/(?P<path>.*)", serve, {"document_root": settings.MEDIA_DIR})
]
