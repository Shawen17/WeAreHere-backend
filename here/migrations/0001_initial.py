    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('videofile', models.JSONField(default=dict, null=True)),
                ('details', models.TextField()),
                ('location', models.TextField()),
                ('state', models.CharField(blank=True, choices=[('', ''), ('Lagos', 'Lagos'), ('Ogun', 'Ogun')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='here.realestate')),
            ],
        ),
    ]
